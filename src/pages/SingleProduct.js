                ...
                <div className="py-3">
                  ...
                  <div className="d-flex gap-10 flex-column my-3">
                    ...
                    <p className="product-data">
                      ...
                      ship all US domestic orders within &emsp;
                  ...
                  <div className="d-flex gap-10 align-items-center my-3">
                    ...
                    <a href="javascript:void(0)" onClick={() =>{
                      copyToClipboard("https://images.pexels.com/photos/190819/pexels-photo-190819.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1");
                    }} 
                    >Copy Product Link</a>
                  </div>
                </div>
            ...
            <div className="col-12">
              ...
              <div className="bg-white p-3">
                <p>
                  ...
                  Alias officia incidunt commodi, est quod fuga eius optio
                  explicabo. Eligendi quae itaque ad id voluptatum similique
                  iusto, enim hic.
                </p>
              </div>
            </div>
              ...
              <div className="review-inner-wrapper">
                ...
                <div className="reviews mt-4">
                  <div className="review">
                    ...
                    <p className="mt-3">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Numquam voluptas hic accusantium quis nostrum consectetur!
                    </p>
                  </div>
                </div>
              </div>
